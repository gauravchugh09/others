...
import com.app.dao.StudentDaoJpa;
...
public class StudentServiceJpa {
	...
	public void insertStudent(Student1 student1) {
		StudentEntity se = new StudentEntity();
		BeanUtils.copyProperties(student1, se);
		studentDaoJpa.insertStudent(se);
	}

	public List<Student1> getAllStudent() {
		List<StudentEntity> studentEntities = studentDaoJpa.getAllStudent();
	...
	public Student1 getStudentById(Integer id) {
		StudentEntity se = studentDaoJpa.getStudentById(id);
	...
	public void deleteStudent(Integer id) {
		studentDaoJpa.deleteStudent(id);
	}
}
